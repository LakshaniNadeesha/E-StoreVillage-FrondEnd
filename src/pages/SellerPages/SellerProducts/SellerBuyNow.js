...
import "../../../components/ProductCard/BuyNow.css";
        ...
        <div className="buy-now-main-container">
            <div className="buy-now-row-container">
                <div className="left-column">
                    <BiArrowBack className="back-arrow" onClick={() => navigate("/seller_product")} size={30} style={{marginLeft:"8%",marginTop:"3%"}}/>
